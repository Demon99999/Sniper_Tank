...
namespace Assets.Scripts.GamePlay.Enemis.EnemyShooting
{
    public class HelicopterShooting : EnemyForwartFlyingBulletsShooting
    {
        ...
        protected override bool CanShoot => base.CanShoot && Vector2.Angle(
            new Vector2(PlayerWrapper.transform.position.x - LookStartPosition.x,
        ...
        protected override Vector3 GetCurrentShootPointPosition()
        {
            ...
            _currentShootPointIndex = _currentShootPointIndex >=
                _bulletPoints.Length - 1 ? 0 : _currentShootPointIndex + 1;
